...
if __name__ == '__main__':
    ...
    # path = '/apps/users/raleigh_ncsu/liuhao/CarbonRCSPS Instances/Orth/'  # online path
    ...
    for inst in Inst_List:
        ...
        Tabu_List_act = []
        Tabu_List_mode = []
        tabu_total_cost, _ = tabu_search(init_act_list, init_mode_list, init_total_cost)
        end_t = time.time()
        time_consuming = end_t-start_t
        print(inst, tabu_total_cost, time_consuming)
